...
import com.cloud.api.bean.image.Hsl;
...
public class ExtractColorUtil {
     ...
     * @throws Exception
     */
    public static Rgb getMainRgbByFilePath(String path) throws Exception {
        BufferedImage image = ImageIO.read(new File(path));
        return getMainRgb(image);
    }
     ...
     * @throws Exception
     */
    public static Rgb getMainRgbByUrl(String url) throws Exception {
     ...
     * @throws Exception
     */
    private static Rgb getMainRgb(BufferedImage image) throws Exception {
